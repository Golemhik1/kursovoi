            ...
            <article class="post">
                ...
                foreach( $result as $img){
                    if ($img['naimenovanie'] == 'Дробовик'  ){
                        ...
                        echo "<span class='podpisi'>Название: $nasvanie<br>Производитель:$strana<br>Марка: $marka<br> Общая длина: $dlina<br>Калибр: $kalibr <br>Длина ствола: $dlina_stvola <br> Масса: $ves <br> Ёмкость магазина: $magasin<br><span class='cena'>Цена: $cena</span><br><br><input type='button' class='st11' value='В корзину' data-id='".$img['id']."'>";
                        echo "</div>";
                    }
                }
                ?>

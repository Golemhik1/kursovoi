...
$data =$conn->prepare("SELECT * FROM `ekipirovka`");
$data ->execute();
        ...
        <section>
            <article class="post">
                ...
                foreach( $result as $img){
                    if ($img['naimenovanie'] == 'Бронежилет'  ){
                        echo "<div class='f1'>";
                        $foto= $img['img'];
                        ...
                        echo "<span class='podpisi'>Название: $nasvanie<br>Производитель:$strana<br> Масса: $ves<br> Марка: $marka<br><span class='cena'>Цена: $cena</span></span><br><input type='button' class='st11' value='В корзину' data-id='".$img['id']."'>";
                        echo "</div>";
                    }
                }
                ?>
